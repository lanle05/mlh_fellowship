    ...
    <>
      ...
      <div className="navbar bg-light1 w-100 p-2 ">
        <div className="  mt-4 d-flex justify-content-between w-100 px-2">
          <div>
            <h2 className=" gothic-header text-capitalize"></h2>
          </div>
          <div className=" inputHighlight ">
            <div className="d-flex  position-relative p-2">
              ...
              <Overlay target={target.current} show={show} placement="bottom">
                {(props) => (
                  <Popover className="border-0" {...props}>
                    <div
                          ...
                          categories.map((item, index) => (
                            ...
                            key={index}
                              onClick={() => {
                                router.push({
                                  pathname:
                                    "/student/otherprofile/teacher-profile",
                                  query: {
                                    id: item.id,
                                  },
                                });
          ...
          <div className="d-flex ">
            <div
              style={{color:'#496ABE'}}
              className="d-flex pointer justify-content-center align-items-center gap-2 rounded-pill bg-white border px-2"
            >
              <Image src={coin_icon} alt="coin" />
              <span className="gothic-medium">20,500</span>
            </div>

            <div onClick={() => router.push("/student/wallet/history")} className="shield-data pointer position-relative">
              {/* badge */}
              <div   className="d-flex pointer justify-content-center align-items-center shield-badge">
                2
              </div>
            ...
            <div onClick={() => router.push("/student/messaging")} className="me-4 pointer position-relative">
              {/* badge */}
              <div   className="d-flex pointer justify-content-center align-items-center shield-badge">
                2
              </div>
