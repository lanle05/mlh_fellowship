...
interface itemProps {
  ...
  onUnenrollClick: (e: React.MouseEvent<HTMLElement, MouseEvent>) => void;
  testName: string;
  testUser: string;
  testType: string;
  ...
  return (
    <Col xl={3} className="p-2">
      ...
      >
        ...
        <button
          ...
          <div className=" ">
            <Dropdown>
              ...
              <Dropdown.Menu>
                <Dropdown.Item  onClick={(e) => props.onCardClick(e)}>{props.startResume}</Dropdown.Item>
                <Dropdown.Item  onClick={(e) => props.onUnenrollClick(e)}>Unenroll</Dropdown.Item>
                <Dropdown.Item >Delete Test</Dropdown.Item>
              </Dropdown.Menu>
            </Dropdown>
          </div>
        </div>
        ...
        <div style={{ color: "#B5B5C3", fontSize: "10px" }}  className={props.dueClass}>
        Due {props.due}
        </div>
