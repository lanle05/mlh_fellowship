        ...
        <Card.Body className="">
          <div className="px-2 py-3">
            <div className="d-flex justify-content-between">
              ...
              <div className=" ">
                <Dropdown>
                  ...
                  <Dropdown.Menu>
                    <Dropdown.Item onClick={(e) => props.onEditClick(e)}>
                      View Test
                    </Dropdown.Item>
            ...
            <Row className=" justify-content-between">
              <Col className="p2">
                <div
                  className="text-white d-flex rounded-2 px-2 py-1"
                  style={{ backgroundColor: "#523F62", fontSize: "8px" }}
                >
                  {" "}
                  <svg
                    className="me-1"
              ...
              <Col className="p2">
                <div
                  className={props.testGradeClass}
                  style={{ fontSize: "8px" }}
                >
                  {" "}
                  <svg
