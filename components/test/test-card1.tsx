  ...
  return (
    <Col xl={3} className="p-3" >
      <Card className={props.testCardClass} style={{ fontSize: "12px" }}>
        <Card.Img
          variant="top"
          style={{ backgroundColor: props.bg , position:'relative'}}
          className="cardimg "
          src={props.src}
        />
        <div className="d-flex gap-2 align-items-center rounded-3" style={{position:'absolute', padding:'4px 10px', right:'7%',top:'40%',backgroundColor:'#6C3D93'}}><svg width="13" height="16" viewBox="0 0 13 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<path fill-rule="evenodd" clip-rule="evenodd" d="M1.25104 15.9172C-1.56267 13.9075 -0.0348169 0.804362 10.014 0.000488281C16.8464 1.36707 7.92268 17.0426 1.25104 15.9172ZM9.66251 1.44755C9.92874 1.45645 10.1374 1.67949 10.1285 1.94572C10.1134 2.39618 9.99272 3.01059 9.74961 3.49298C9.62868 3.73294 9.45516 3.98511 9.2067 4.15086C8.93411 4.33271 8.5988 4.38986 8.24857 4.26124C7.90924 4.13662 7.7024 4.24611 7.57725 4.41275C7.42818 4.61123 7.37518 4.92693 7.48745 5.2076C7.75758 5.88293 7.76459 6.49124 7.3873 6.9249C7.04343 7.32015 6.50903 7.40787 6.10869 7.40787C5.77885 7.40787 5.45797 7.46971 5.27062 7.61465C5.19012 7.67692 5.13053 7.75687 5.09952 7.87681C5.06647 8.00464 5.05847 8.2088 5.14301 8.52272C5.35439 9.30765 5.34785 9.98502 4.94138 10.4798C4.55643 10.9484 3.92337 11.1053 3.30187 11.1779L3.29986 11.1781C3.29283 11.1787 3.28422 11.1793 3.26411 11.208C3.23369 11.2515 3.19537 11.3414 3.17748 11.4906C3.14165 11.7895 3.20403 12.1943 3.36632 12.5488C3.51927 12.8828 3.47561 13.2119 3.30027 13.4798C3.14745 13.7133 2.91074 13.8778 2.70289 13.9947C2.40668 14.1614 2.01698 14.307 1.73047 14.4141C1.62721 14.4526 1.53735 14.4862 1.4701 14.514C1.22385 14.6156 0.941871 14.4983 0.84027 14.2521C0.73867 14.0058 0.855926 13.7238 1.10217 13.6222C1.22772 13.5704 1.35583 13.5227 1.48328 13.4753L1.48331 13.4753L1.48332 13.4753L1.48333 13.4753C1.63948 13.4172 1.79466 13.3594 1.943 13.2949C1.95208 13.2845 1.96096 13.2741 1.96961 13.2637C2.16068 13.0325 2.19784 12.8359 2.11677 12.6588C1.89738 12.1797 1.80094 11.6191 1.85731 11.1489C1.91056 10.7046 2.1381 10.1665 2.72177 10.0983C3.32434 10.0278 3.64974 9.89425 3.80707 9.70273C3.94826 9.53086 4.03526 9.20417 3.84588 8.50092C3.73533 8.09039 3.72063 7.73211 3.80022 7.42425C3.88134 7.11048 4.05408 6.87437 4.27204 6.70575C4.68819 6.38381 5.24772 6.32252 5.62659 6.32252C5.95258 6.32252 6.17007 6.24262 6.2684 6.12959C6.34167 6.04538 6.44109 5.82837 6.22165 5.27979C6.00194 4.73051 6.09088 4.1031 6.42023 3.66457C6.76752 3.20216 7.366 2.97368 8.05746 3.22762C8.25973 3.30191 8.52843 3.22456 8.80124 2.94362C8.90067 2.84123 8.98682 2.72451 9.05637 2.60345C9.12042 2.3655 9.15755 2.11683 9.16434 1.91349C9.17324 1.64726 9.39628 1.43865 9.66251 1.44755Z" fill="#FFE993"/>
<path d="M1.04543 15.7559C0.0807822 4.63031 6.83353 0.964648 10.3702 0.0803873L10.0487 0L8.84289 0.160775C5.54702 0.723486 3.30044 2.817 1.84919 5.22518C-0.401597 9.24454 -0.482571 14.1482 1.04543 15.7559Z" fill="#FDF3BD" fill-opacity="0.63"/>
<path d="M1.76855 15.9972C8.44069 13.4248 11.4143 7.71735 12.1385 1.60791C12.3797 2.25101 12.5432 3.115 12.46 3.93914C11.6562 9.80742 5.8683 16.158 1.76855 15.9972Z" fill="#C28D32" fill-opacity="0.54"/>
</svg> <div className="text-white" style={{ fontSize: "15px" }}>{props.test_price}</div>
</div>
        <Card.Body className="">
          <div className="p-3">
            ...
            <div className="d-flex mb-2">
              <div
                className="text-white rounded-2 px-2"
                style={{ backgroundColor: "#523F62" }}
              >
                {" "}
                <svg
                  className="me-1"
                ...
                >
                  <path
                    d="M8.2055 5.00195V2.5591C8.2055 1.83903 8.2055 1.47899 8.05438 1.20397C7.92145 0.962043 7.70933 0.765353 7.44843 0.642088C7.15183 0.501953 6.76356 0.501953 5.98702 0.501953H3.02903C2.25249 0.501953 1.86422 0.501953 1.56762 0.642088C1.30672 0.765353 1.09461 0.962043 0.961672 1.20397C0.810547 1.47899 0.810547 1.83903 0.810547 2.5591V7.01624C0.810547 7.73631 0.810547 8.09634 0.961672 8.37137C1.09461 8.61329 1.30672 8.80998 1.56762 8.93325C1.86422 9.07338 2.25249 9.07338 3.02903 9.07338H4.50803M5.4324 4.3591H2.65929M3.58366 6.07338H2.65929M6.35677 2.64481H2.65929M5.66349 7.78767L6.58786 8.64481L8.66769 6.71624"
                    stroke="#EFF6FF"
